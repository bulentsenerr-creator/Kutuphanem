// Basit PWA Service Worker (App Shell + runtime caching)
// Not: Service worker'lar HTTPS/secure origin ister.
...
self.addEventListener('fetch', (event) => {
  ...
  // Cross-origin (APIs, covers): network-first + cache fallback
  if (req.method === 'GET') {
...
async function networkFirst(req){
  ...
  try{
    ...
    // opaque da olsa cache'lenebilir
